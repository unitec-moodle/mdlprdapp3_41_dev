...
/**
 * Creates a navbar for boost_arch that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_arch.
     */
     ...
     *
     * @return boostnavbaritem[] boost_arch navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_arch navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_arch navbar.
     *
