...
/**
 * Creates a navbar for boost_bdgpnt that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_bdgpnt.
     */
     ...
     *
     * @return boostnavbaritem[] boost_bdgpnt navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_bdgpnt navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_bdgpnt navbar.
     *
