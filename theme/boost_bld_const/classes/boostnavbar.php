...
/**
 * Creates a navbar for boost_bld_const that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_bld_const.
     */
     ...
     *
     * @return boostnavbaritem[] boost_bld_const navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_bld_const navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_bld_const navbar.
     *
