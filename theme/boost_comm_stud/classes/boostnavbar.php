...
/**
 * Creates a navbar for boost_comm_stud that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_comm_stud.
     */
     ...
     *
     * @return boostnavbaritem[] boost_comm_stud navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_comm_stud navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_comm_stud navbar.
     *
