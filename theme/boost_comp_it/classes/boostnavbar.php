...
/**
 * Creates a navbar for boost_comp_it that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_comp_it.
     */
     ...
     *
     * @return boostnavbaritem[] boost_comp_it navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_comp_it navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_comp_it navbar.
     *
