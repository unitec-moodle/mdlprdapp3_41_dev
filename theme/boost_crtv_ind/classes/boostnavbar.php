...
/**
 * Creates a navbar for boost_crtv_ind that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_crtv_ind.
     */
     ...
     *
     * @return boostnavbaritem[] boost_crtv_ind navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_crtv_ind navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_crtv_ind navbar.
     *
