...
/**
 * Creates a navbar for boost_eng_app_tech that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_eng_app_tech.
     */
     ...
     *
     * @return boostnavbaritem[] boost_eng_app_tech navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_eng_app_tech navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_eng_app_tech navbar.
     *
