...
/**
 * Creates a navbar for boost_env_ani_sci that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_env_ani_sci.
     */
     ...
     *
     * @return boostnavbaritem[] boost_env_ani_sci navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_env_ani_sci navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_env_ani_sci navbar.
     *
