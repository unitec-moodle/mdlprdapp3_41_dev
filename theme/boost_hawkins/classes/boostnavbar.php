...
/**
 * Creates a navbar for boost_hawkins that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_hawkins.
     */
     ...
     *
     * @return boostnavbaritem[] boost_hawkins navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_hawkins navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_hawkins navbar.
     *
