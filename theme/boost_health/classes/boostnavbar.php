...
/**
 * Creates a navbar for boost_health that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_health.
     */
     ...
     *
     * @return boostnavbaritem[] boost_health navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_health navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_health navbar.
     *
