...
* remove folder theme/boost_health/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_health/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_health/amd/src
* edit theme/boost_health/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/boost_health run "grunt css" to compile scss
