...
/**
 * Creates a navbar for boost_soc_prac that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_soc_prac.
     */
     ...
     *
     * @return boostnavbaritem[] boost_soc_prac navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_soc_prac navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_soc_prac navbar.
     *
