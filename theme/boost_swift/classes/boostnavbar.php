...
/**
 * Creates a navbar for boost_swift that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_swift.
     */
     ...
     *
     * @return boostnavbaritem[] boost_swift navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_swift navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_swift navbar.
     *
