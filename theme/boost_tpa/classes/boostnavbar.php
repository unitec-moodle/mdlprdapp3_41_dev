...
/**
 * Creates a navbar for boost_tpa that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_tpa.
     */
     ...
     *
     * @return boostnavbaritem[] boost_tpa navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_tpa navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_tpa navbar.
     *
