...
/**
 * Creates a navbar for boost_trds_serv that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_trds_serv.
     */
     ...
     *
     * @return boostnavbaritem[] boost_trds_serv navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_trds_serv navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_trds_serv navbar.
     *
