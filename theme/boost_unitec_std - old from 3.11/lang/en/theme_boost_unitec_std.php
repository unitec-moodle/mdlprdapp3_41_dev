...
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href="https://docs.moodle.org/dev/boost_unitec_std_Presets">boost_unitec_std presets</a> for information on creating and sharing your own preset files, and see the <a href="https://archive.moodle.net/boost_unitec_std">Presets repository</a> for presets that others have shared.';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['privacy:metadata'] = 'The boost_unitec_std theme does not store any personal data about any user.';
