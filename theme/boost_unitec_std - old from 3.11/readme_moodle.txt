...
* remove folder theme/boost_unitec_std/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_unitec_std/scss/bootstrap
...
* comment out this line in theme/boost_unitec_std/scss/_print.scss
    @page {
...
* remove folder theme/boost_unitec_std/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_unitec_std/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_unitec_std/amd/src
* edit theme/boost_unitec_std/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/boost_unitec_std run "grunt amd" to compile the bootstrap JS
* in folder theme/boost_unitec_std run "grunt css" to compile scss
