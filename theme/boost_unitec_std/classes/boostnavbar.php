...
/**
 * Creates a navbar for boost_unitec_std that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with boost_unitec_std.
     */
     ...
     *
     * @return boostnavbaritem[] boost_unitec_std navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_unitec_std navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_unitec_std navbar.
     *
