...
use \theme_boost_unitec_std\privacy\provider;

/**
 * Unit tests for theme_boost_unitec_std/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_unitec_std_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_boost_unitec_std'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_boost_unitec_std'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
