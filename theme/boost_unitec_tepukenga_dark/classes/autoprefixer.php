 ...
 * theme boost_unitec_tepukenga_dark when working with Bootstrap 4 alpha. We do not recommend
...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_boost_unitec_tepukenga_dark\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/boost_unitec_tepukenga_dark/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
