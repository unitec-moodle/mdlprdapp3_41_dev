...
/**
 * Creates a navbar for boost_unitec_tepukenga_dark that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_boost_unitec_tepukenga_dark();
    }

    /**
     * Prepares the navigation nodes for use with boost_unitec_tepukenga_dark.
     */
    protected function prepare_nodes_for_boost_unitec_tepukenga_dark(): void {
        global $PAGE;
     ...
     *
     * @return boostnavbaritem[] boost_unitec_tepukenga_dark navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_unitec_tepukenga_dark navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_unitec_tepukenga_dark navbar.
     *
