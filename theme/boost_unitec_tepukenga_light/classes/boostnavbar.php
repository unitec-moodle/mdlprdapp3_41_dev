...
/**
 * Creates a navbar for boost_unitec_tepukenga_light that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_boost_unitec_tepukenga_light();
    }

    /**
     * Prepares the navigation nodes for use with boost_unitec_tepukenga_light.
     */
    protected function prepare_nodes_for_boost_unitec_tepukenga_light(): void {
        global $PAGE;
     ...
     *
     * @return boostnavbaritem[] boost_unitec_tepukenga_light navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_unitec_tepukenga_light navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_unitec_tepukenga_light navbar.
     *
