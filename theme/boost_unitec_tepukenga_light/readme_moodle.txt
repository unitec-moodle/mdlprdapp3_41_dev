...
* remove folder theme/boost_unitec_tepukenga_light/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_unitec_tepukenga_light/scss/bootstrap
...
* comment out this line in theme/boost_unitec_tepukenga_light/scss/_print.scss
    @page {
...
* remove folder theme/boost_unitec_tepukenga_light/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_unitec_tepukenga_light/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_unitec_tepukenga_light/amd/src
* edit theme/boost_unitec_tepukenga_light/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/boost_unitec_tepukenga_light run "grunt amd" to compile the bootstrap JS
* in folder theme/boost_unitec_tepukenga_light run "grunt css" to compile scss
