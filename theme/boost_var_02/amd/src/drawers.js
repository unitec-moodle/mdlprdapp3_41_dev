...
// The jQuery module is only used for interacting with boost_var_02rap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in boost_var_02rap 4. It can we removed when MDL-71979 is integrated.
