...
* remove folder theme/boost_var_02/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_var_02/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_var_02/amd/src
* edit theme/boost_var_02/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/boost_var_02 run "grunt css" to compile scss
