...
/**
 * Navigation step definition overrides for the classic_unitec_std theme.
 *
...
/**
 * Step definitions and overrides to navigate through the navigation tree nodes in the classic_unitec_std theme.
 *
 * @package    theme_classic_unitec_std
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_classic_unitec_std_behat_navigation extends behat_navigation {
    /**
