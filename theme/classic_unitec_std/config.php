...
$THEME->extrascsscallback = 'theme_classic_unitec_std_get_extra_scss';
$THEME->prescsscallback = 'theme_classic_unitec_std_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_classic_unitec_std_get_precompiled_css';
$THEME->yuicssmodules = array();
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
$THEME->scss = function($theme) {
    return theme_classic_unitec_std_get_main_scss_content($theme);
};
