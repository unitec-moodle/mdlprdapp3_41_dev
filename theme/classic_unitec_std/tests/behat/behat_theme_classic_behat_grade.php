...
/**
 * Behat grade related step definition overrides for the classic_unitec_std theme.
 *
...
/**
 * Behat grade overrides for the classic_unitec_std theme.
 *
 * @package    theme_classic_unitec_std
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_classic_unitec_std_behat_grade extends behat_grade {
