...
/**
 * Override definitions for the upload repository type for the classic_unitec_std theme.
 *
...
/**
 * Override step definitions to deal with the upload repository in the classic_unitec_std theme.
 *
 * @package    theme_classic_unitec_std
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_classic_unitec_std_behat_repository_upload extends behat_repository_upload {
