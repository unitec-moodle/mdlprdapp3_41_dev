...
/**
 * Step definitions related to administration overrides for the classic_unitec_tepukenga_dark theme.
 *
...
/**
 * Site administration level steps definitions overrides for the classic_unitec_tepukenga_dark theme.
 *
 * @package    theme_classic_unitec_tepukenga_dark
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_classic_unitec_tepukenga_dark_behat_admin extends behat_admin {
